...
//    private DirectCompilerResult declareExternalFunction(ExpressionContext bodyCtx, FEEL_1_1Parser.FormalParametersContext parametersCtx) {
//        ASTBuilderVisitor evaluatingVisitor = new ASTBuilderVisitor(Collections.emptyMap());
//        BaseNode baseNode = evaluatingVisitor.visitFunctionDefinition(bodyCtx);
//        Expression expression = visit(bodyCtx).getExpression();
//
//        ASTBuilderFactory.newFunctionDefinition(bodyCtx, parametersCtx, true, bodyCtx);
//        throw new UnsupportedOperationException("TODO"); // TODO
//    }
