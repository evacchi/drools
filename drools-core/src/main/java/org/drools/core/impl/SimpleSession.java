...
public class SimpleSession extends AbstractRuntime implements InternalWorkingMemoryActions,
    ...
    public SimpleSession(final long id,
    ...
    private SimpleSession(final long id,
                          final InternalKnowledgeBase kBase,
                          final FactHandleFactory handleFactory,
    ...
    public SimpleSession setStateless(boolean stateless) {
    ...
    public <T extends FactHandle> Collection<T> getFactHandles() {
        return new MyObjectStoreWrapper(getObjectStore(),
                                        null,
                                        MyObjectStoreWrapper.FACT_HANDLE);
    }
    ...
    public void clearNodeMemory(final MemoryFactory node) {
        if (nodeMemories != null) {
            nodeMemories.clearNodeMemory(node);
        }
    }
