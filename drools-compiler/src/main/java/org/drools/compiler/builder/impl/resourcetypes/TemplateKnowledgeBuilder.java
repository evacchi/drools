...
public class TemplateKnowledgeBuilder {
    ...
    DSLRKnowledgeBuilder dslrPackage;
    private KnowledgeBuilderConfigurationImpl configuration;
    private BuilderResultCollector results;

    public TemplateKnowledgeBuilder(KnowledgeBuilderImpl knowledgeBuilder) {

    }

    public PackageDescr templateToPackageDescr(Resource resource) throws DroolsParserException,
            IOException {
