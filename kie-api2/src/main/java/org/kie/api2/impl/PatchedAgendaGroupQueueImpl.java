 ...
 * @see PriorityQueue
 */
public class PatchedAgendaGroupQueueImpl
        implements
        InternalAgendaGroup,
    ...
    public PatchedAgendaGroupQueueImpl(final String name,
                                       final InternalKnowledgeBase kBase) {
        this.name = name;
        this.sequential = true; // kBase.getConfiguration().isSequential();
    ...
    public boolean equals(final Object object) {
        return object instanceof PatchedAgendaGroupQueueImpl &&
               ((PatchedAgendaGroupQueueImpl) object).name.equals(this.name );
    }
